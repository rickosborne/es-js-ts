...
export const isDigit = (value: unknown): value is Digit => typeof value === "string" && value.length === 1 && "0".localeCompare(value) <= 0 && "9".localeCompare(value) >= 0;

export type HexDigit = Digit | "A" | "B" | "C" | "D" | "E" | "F" | "a" | "b" | "c" | "d" | "e" | "f";

export const isHexDigit = (value: unknown): value is HexDigit => {
